...
def lessThan15Siblings(listFam):
    siblingList = []
    for i in listFam:
        if(len(i[5]) >= 15):
            siblingList.append(i[0])
            print('User story 15: The family with id ' + i[0] + ' has 15 or more siblings.')
    if(len(siblingList)==0):
        print("User story 15: There are no families with 15 or more siblings.")
    else:
        print("User story 15: The families with 15 or more siblings are as follows: ")
        print(siblingList)
