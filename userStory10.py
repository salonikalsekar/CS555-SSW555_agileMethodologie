...
def marriageAfter14(list_individual, list_family):
    marriageAfter_list = []
    for i in list_family:
        if(getMarriageByID(list_individual, i[1], i[3])<14):
            marriageAfter_list.append(i[1])
            print("User Story 10: This individual with ID " + i[1] + " married before he/she turned 14 in family with ID" + i[0])
        if(getMarriageByID(list_individual, i[2], i[3])<14):
            marriageAfter_list.append(i[2])
            print("User Story 10: This individual with ID " + i[2] + " married before he/she turned 14 in family with ID " + i[0])

    if(len(marriageAfter_list) != 0):
        print("User Story 10: The individuals mentioned below married before they turned 14: ")
        print(marriageAfter_list)       
    else:
        print("User Story 10: There are no individuals who married before they turned 14 years.")
