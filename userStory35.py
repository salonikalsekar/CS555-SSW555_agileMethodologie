...
def recentBirthList(list_individual):
    ...
    if (len(recentBirthList) != 0):
        print("User story 35, the following individuals are born recently")
        print(recentBirthList)
    else:
        print("User story 35,there are no individuals who are born recently")      
...
def main(gedFileName):
    ...
    list_family.sort()
    recentBirthList(list_individual)
